...
mongoose.connect(
  'mongodb://localhost:27017/stock_management',
  {
...
const undefinedWarehouseId = mongoose.Types.ObjectId(
  '601749f9c814381929e89fa5'
);
...
const undefinedProductSubId = mongoose.Types.ObjectId(
  '601b6ff343394661fdb6996b'
);
...
const OperatorModel = mongoose.model(
  'operator',
  mongoose.Schema({
...
const DriverModel = mongoose.model(
  'driver',
  mongoose.Schema({
    name: { type: String, required: true },
...
const DriverAccountingModel = mongoose.model(
  'driverAccount',
  mongoose.Schema({
...
const ShelfModel = mongoose.model(
  'shelf',
  mongoose.Schema({
    warehouseRef: {
      type: mongoose.Schema.ObjectId,
...
const ProductSubModel = mongoose.model(
  'productSub',
  mongoose.Schema({
    productRef: {
      type: mongoose.Schema.ObjectId,
